...
@section('title')
    E-Sport Tournament : Mobile Legend | FAST UPB 2021
@endsection
@section('content')
<section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/bg-breadcrumbs-01-1894x424.jpg);">
    <div class="container">
      ...
      <h3 class="breadcrumbs-custom-title">E-Sport Tournament : Mobile legend</h3>
    </div>
  </section>
      <!-- Section Who We are-->
      <section class="section section-lg bg-default">
        <div class="container">
          <div class="row row-30 justify-content-center">
            ...
            {{-- <a class="button button-primary button-round-1 wow fadeScale" href="#" target="_blank" data-triangle=".button-overlay"><span>Daftar lomba</span><span class="button-overlay"></span></a></div> --}}
          </div>
        </div>
      </section>
@endsection
