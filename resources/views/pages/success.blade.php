...
<div class="wrapperAlert">
    ...
    <div class="contentAlert">
      ...
      <div class="bottomHalf">
        ...
        <p>Selamat!, Pendaftaran kamu telah berhasil , selanjutnya tunggu kabar selanjutnya ya, terima kasih partisipasinya :)</p>

        <a href="/">
            <button id="alertMO">Kembali ke Beranda</button>
        </a>
